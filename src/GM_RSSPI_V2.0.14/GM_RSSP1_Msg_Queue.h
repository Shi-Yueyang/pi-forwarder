...
#ifndef GM_RSSP1_MSG_QUEUE_H_
#define GM_RSSP1_MSG_QUEUE_H_
...
extern "C"
{
	...
	#define GM_MAX_QUEUE_ELE_LEN    (GM_RSSP1_MAX_USER_DAT_LEN+100U)    /*队列元素的最大字节数*/
    ...
    */
    typedef enum
    {
        FSFB_Q_TYPE_SFM_U2L_PRI	= 0x10U,  /**< SFM 应用层服务请求原语队列 */
        FSFB_Q_TYPE_SFM_L2U_PRI	= 0x12U,  /**< SFM 向应用层报告连接状态、事件队列     */

        FSFB_Q_TYPE_CFM_U2L_PRI	= 0x20U,  /**< CFM 来自安全层的原语队列       */
        FSFB_Q_TYPE_CFM_L2U_PRI	= 0x22U,  /**< CFM 向安全层报告原语队列     */

        FSFB_Q_TYPE_SENT_PKT    = 0x30U,  /**< 通信通道待发送的数据包队列 */
        FSFB_Q_TYPE_RCVD_PKT    = 0x32U,  /**< 通信通道接收到的数据包队列 */

        FSFB_Q_TYPE_UNKNOWN		= 0xffU
    ...
    typedef struct
    {
        ...
        GM_RSSP1_Pointer					head_Position;  /**< 头指针 */
        GM_RSSP1_Pointer					tail_Position;  /**< 尾指针 */
        GM_RSSP1_UINT32						count;          /**< 当前队列中已有的元素个数 */

        GM_RSSP1_UINT32						Q_size;         /**< 队列总容量 */
        GM_RSSP1_Pointer					Q_offset;       /**< 队列头地址偏移量 */
    ...
    */
    typedef enum
    {
        Q_WRITE_OK_NOT_FULL     = 0x11U, /**< 队列未满 */
        Q_WRITE_OK_FULL         = 0x22U, /**< 队列已满 */
        Q_WRITE_FAIL            = 0xffU  /**< 写队列失败 */
